      ...
      <div className="min-h-full lg:h-full flex flex-col">
        ...
        <section className="flex-grow lg:flex-1 relative px-8 py-8 pt-[32px] lg:pt-8 lg:min-h-0">
          ...
          <div className="lg:hidden flex flex-col items-center justify-start space-y-4 md:space-y-6">
            {/* Mockup Image */}
            <div className="w-full max-w-4xl flex-shrink-0 px-4">
              {/* Light mode mockup */}
              <Image
                ...
                width={2400}
                height={1600}
                className="w-full h-auto min-h-[400px] max-h-[80vh] lg:max-h-[40vh] object-contain drop-shadow-2xl dark:hidden"
                priority
              />
              {/* Dark mode mockup */}
              <Image
                ...
                width={2400}
                height={1600}
                className="w-full h-auto min-h-[400px] max-h-[80vh] lg:max-h-[40vh] object-contain drop-shadow-2xl hidden dark:block"
                priority
              />
            </div>
