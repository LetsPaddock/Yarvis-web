...
const roadmapStages: RoadmapStage[] = [
  ...
  },
  {
    ...
    description:
      "Personalize your screensaver with custom backgrounds and typography",
    status: "upcoming",
  },
  {
    id: 3,
    title: "More Widgets",
    description:
      "Extended widget library with customizable information displays",
    status: "upcoming",
  },
];
          ...
          {roadmapItems.map((item, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              ...
              <div className="mt-4 md:mt-6">
                <h3
                  className={`font-semibold text-xs md:text-base mb-1 md:mb-2 ${
                    item.isActive
                      ? "text-blue-600"
